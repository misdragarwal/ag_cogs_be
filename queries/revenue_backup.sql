...
BILLACCUNIT.ACCOUNTUNIT AS BILLED,
	...
	0 AS SGST,
	0 AS 'GST_PERCENTAGE',
	(DETAIL.SERVICE_AMOUNT - DETAIL.SERVICE_DISCOUNT) AS 'Patient_Amount_WO_GST',
	0 AS 'CGST_Value',
	0 AS 'SGST_Value',
	'' AS 'MANUFACTURER',
	'' AS 'COSTPRICE',
	...
	IF(BILL.PATIENT_ID IS NULL,CUSTOMER.CUSTOMERPHONE,PATIENT.MOBILENO) AS PATIENT_MOBILENO,
	IF(BILL.PATIENT_ID IS NULL,'',PATIENT.EMAILID) AS PATIENT_MAILID,
	IF(BILL.PATIENT_ID IS NULL,'',RIC.GENDER) AS PATIENT_GENDER
FROM
...
ACCHEAD.ACCOUNTHEAD AS UNIT,
	...
	0 AS SGST,
	0 AS 'GST_PERCENTAGE',
	-(DETAIL.SERVICE_AMOUNT - DETAIL.SERVICE_DISCOUNT) AS 'Patient Amount W/O GST',
	0 AS 'CGST Value',
	0 AS 'SGST Value',
	'' AS 'MANUFACTURER'
	,'' AS 'COSTPRICE'
...
ACCHEAD.ACCOUNTHEAD AS UNIT,
	...
	IF(PAYORTYPE.PAYORCATEGORY IS NULL, 'Self', IF(PAYORTYPE.PAYORCATEGORY ='Cash','Self',PAYORTYPE.PAYORCATEGORY)) AS PAYORTYPE,
	IF(PAYORTYPE.PAYORCATEGORY IS NULL, 'SELF PAYING', PAYORTYPE.PAYORTYP) AS PAYORNAME,
	TAX.CGSTVALUE AS CGST,
	TAX.SGSTVALUE AS SGST,
	(TAX.CGSTVALUE+TAX.SGSTVALUE) AS 'GST%',
	ROUND(100/(100+(TAX.CGSTVALUE+TAX.SGSTVALUE))*((DIRECTSALESDETAIL.TOTAL - IF(DIRECTSALESDETAIL.DISCOUNTAMOUNT IS NULL, 0, DIRECTSALESDETAIL.DISCOUNTAMOUNT))),2) AS 'Patient Amount W/O GST',
	ROUND((100/(100+(TAX.CGSTVALUE+TAX.CGSTVALUE))*((DIRECTSALESDETAIL.TOTAL - IF(DIRECTSALESDETAIL.DISCOUNTAMOUNT IS NULL, 0, DIRECTSALESDETAIL.DISCOUNTAMOUNT)) * (TAX.CGSTVALUE/100))),2) AS 'CGST Value',
	ROUND((100/(100+(TAX.SGSTVALUE+TAX.SGSTVALUE))*((DIRECTSALESDETAIL.TOTAL - IF(DIRECTSALESDETAIL.DISCOUNTAMOUNT IS NULL, 0, DIRECTSALESDETAIL.DISCOUNTAMOUNT)) * (TAX.SGSTVALUE/100))),2) AS 'SGST Value',
	MANF.`MANUFACTURER` AS 'MANUFACTURER',
...
FROM
	...
	ON MANF.ID = ITEM.`MANUFACTURERID` 
...
BILLACCUNIT.ACCOUNTUNIT AS BILLED,
	...
	TAX.SGSTVALUE AS SGST,
	(TAX.CGSTVALUE+TAX.SGSTVALUE) AS 'GST%',
	ROUND((100/(100+(TAX.CGSTVALUE+TAX.SGSTVALUE))*IF(DIRECTSALES.SALESSTATUS = 'Advance Received',-(DIRECTSALESDETAIL.TOTAL-IF(DIRECTSALESDETAIL.DISCOUNTAMOUNT IS NULL, 0, DIRECTSALESDETAIL.DISCOUNTAMOUNT)),-SALESRETURNDETAIL.RETURNAMOUNT)),2) AS 'Patient Amount W/O GST',  -- DIRECTSALESDETAIL.REFUNDAMOUNT updated as SALESRETURNDETAIL.RETURNAMOUNT
	ROUND(((100/(100+(TAX.CGSTVALUE+TAX.CGSTVALUE))*IF(DIRECTSALES.SALESSTATUS = 'Advance Received',-(DIRECTSALESDETAIL.TOTAL-IF(DIRECTSALESDETAIL.DISCOUNTAMOUNT IS NULL, 0, DIRECTSALESDETAIL.DISCOUNTAMOUNT)),-SALESRETURNDETAIL.RETURNAMOUNT) * (TAX.CGSTVALUE/100))),2) AS 'CGST Value', -- DIRECTSALESDETAIL.REFUNDAMOUNT updated as SALESRETURNDETAIL.RETURNAMOUNT
	ROUND(((100/(100+(TAX.SGSTVALUE+TAX.SGSTVALUE))*IF(DIRECTSALES.SALESSTATUS = 'Advance Received',-(DIRECTSALESDETAIL.TOTAL-IF(DIRECTSALESDETAIL.DISCOUNTAMOUNT IS NULL, 0, DIRECTSALESDETAIL.DISCOUNTAMOUNT)),-SALESRETURNDETAIL.RETURNAMOUNT) * (TAX.SGSTVALUE/100))),2) AS 'SGST Value', -- DIRECTSALESDETAIL.REFUNDAMOUNT updated as SALESRETURNDETAIL.RETURNAMOUNT
	MANF.`MANUFACTURER` AS 'MANUFACTURER',
