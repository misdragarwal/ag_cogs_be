...
let filterGroupwise = async (
  ...
  let ahcgroupedBranches = {
	...
	Punjab :["PMH","MLI","PLA","PML","MDC"],
  Jammu :["JMU"],
  Gujarat: ["AHM","SMH","AJR","VES","BNR","VPI"],
...
exports.newopdNative = async (
  ...
  let entityWise = await filterEntityOpd(dbres2, ftddate,lastyearopd,lastyearopdpre);
  ...
  let tamilNaduBranches = await filterTamilNaduRevenue(dbres2, ftddate,lastyearopd,lastyearopdpre,branches); 
...
let filterEntityOpd = async (dbres2, ftddate,lastyearopd,lastyearopdpre) => {
  let tempObj = {},
    opd = 0,
    opdlastyear = 0,
	opdlastyearpre=0,
    ...
    aehrevarr = [],
	aehrevarrlastyear = [],
	aehrevarrlastyearpre = [],
    ahcrevarr = [],
	ahcrevarrlastyear = [],
	ahcrevarrlastyearpre = [],
    ahcarr = [],
	ohcrevarr=[],
	ohcrevarrlastyear=[],
	ohcrevarrlastyearpre=[],
  ...
  aehrevarrlastyear = _.filter(lastyearopd, { entity: "AEH" });
   ...
   aehrevarrlastyearpre = _.filter(lastyearopdpre, { entity: "AEH" });
  ...
  (opd = 0),(opdlastyear = 0),(opdlastyearpre=0);
  aehrevarr.forEach(element => {
    opd += element.ftd_count;
  ...
  aehrevarrlastyearpre.forEach(element => {
    opdlastyearpre += element.ftd_count;
  ...
  (tempObj.AEH.mtdopdrevlastyearpre = opdlastyearpre);
  (tempObj.AEH.mtdopdpercentage = mtdGR(opd,opdlastyear));
  (tempObj.AEH.mtdopdpercentagepre = mtdGRpre(opd,opdlastyearpre));
  (opd = 0),(opdlastyear = 0),(opdlastyearpre = 0);
  ahcrevarr = _.filter(dbres2, { entity: "AHC" });
  
  ahcrevarrlastyear = _.filter(lastyearopd, { entity: "AHC" });
  
  ahcrevarrlastyearpre = _.filter(lastyearopdpre, { entity: "AHC" });
  _.filter(ahcrevarr, { trans_date: ftddate }).forEach(element => {
    opd += element.ftd_count;
  ...
  ahcrevarrlastyearpre.forEach(element => {
    opdlastyearpre += element.ftd_count;
  ...
  (tempObj.AHC.mtdopdrevlastyearpre = opdlastyearpre);
  (tempObj.AHC.mtdopdpercentage = mtdGR(opd,opdlastyear));
  (tempObj.AHC.mtdopdpercentagepre = mtdGRpre(opd,opdlastyearpre));
  /*for (let key in tempObj.AEH) {
    alin[key] = tempObj.AEH[key];
  }
  for (let key in tempObj.AHC) {
  ...
  ohcrevarrlastyearpre = _.filter(lastyearopdpre, { entity: "OHC" });
  ...
  ohcrevarrlastyearpre.forEach(element => {
    opdlastyearpre += element.ftd_count;
  ...
  (tempObj.OHC.mtdopdrevlastyearpre = opdlastyearpre);
  (tempObj.OHC.mtdopdpercentage = mtdGR(opd,opdlastyear));
  (tempObj.OHC.mtdopdpercentagepre = mtdGRpre(opd,opdlastyearpre));
  alin["branch"] = "All India";  
  ...
  alin['mtdopdrevlastyearpre'] =  tempObj.AEH['mtdopdrevlastyearpre']+tempObj.AHC['mtdopdrevlastyearpre'];
  alin['mtdopdpercentage'] = mtdGR(alin['mtdopdrev'],alin['mtdopdrevlastyear']);
  alin['mtdopdpercentagepre'] = mtdGRpre(alin['mtdopdrev'],alin['mtdopdrevlastyearpre']);
  let gropuftd=0,
  gropumtd=0,
  groupmtdlastyear=0,
  groupmtdlastyearpre=0,
  ...
  groupmtdlastyearpre = tempObj.AEH['mtdopdrevlastyearpre']+tempObj.AHC['mtdopdrevlastyearpre']+tempObj.OHC['mtdopdrevlastyearpre'];
  groupmtdpercentage = mtdGR(gropumtd,groupmtdlastyear);
  groupmtdpercentagepre = mtdGRpre(gropumtd,groupmtdlastyearpre);
  ...
  group['mtdopdrevlastyearpre'] =  groupmtdlastyearpre;
  group['mtdopdpercentage'] = groupmtdpercentage;
  group['mtdopdpercentagepre'] = groupmtdpercentagepre;
...
let filterGroupwiseOPD = async (
  ...
  let ahcgroupedBranches = {
	...
	"Maharashtra" :["VSH", "PUN", "HDP","CMR","NMH","CGR","MMH","KTD","PCH","SNG","VNR","VWD"], 
	"Mumbai" :["VSH","CMR","MMH"], 
	"Rest of Maharashtra" :["PUN","HDP","NMH","CGR","KTD","PCH","SNG","VNR","VWD"], 
	Punjab :["PMH","MLI","PLA","PML","MDC"],
  Jammu :["JMU"],
  Gujarat: ["AHM","SMH","AJR","VES","BNR","VPI"],
    Telangana: ["DNR", "HMH", "MDA", "SNR", "HIM", "SBD","MPM","GCB"],
  ...
  aehGroups.forEach(group => {
    ...
    aehgroupedBranches[group].forEach(branch => {
      ...
      _.filter(dbres2, { branch: branch }).forEach(element => {
	   ...
	   _.filter(lastyearopdpre, { branch: branch }).forEach(element => {
        mtdopdlastyearpre += element.ftd_count;
       
      });
	  mtdopdpercentage = mtdGR(mtdopd,mtdopdlastyear);
	  mtdopdpercentagepre = mtdGRpre(mtdopd,mtdopdlastyearpre);
	  ...
	  (aehtempObj[group].mtdopdrevlastyearpre = mtdopdlastyearpre),
	  (aehtempObj[group].mtdopdpercentagepre = mtdopdpercentagepre),
	  (aehtempObj[group].branch = group);
    });
    (ftdopd = 0),
    (ftdopdrev = 0),
    ...
    aehgroupedBranches[key].forEach(branch => {
	  ...
	  _.filter(lastyearopd, { branch: branch }).forEach(element => {
	   ...
	   _.filter(lastyearopdpre, { branch: branch }).forEach(element => {
          ...
          (mtdopdrevlastyearpre += element.ftd_count);
      });
      
      mtdopdpercentage = mtdGR(mtdopdrev,mtdopdrevlastyear);
	  mtdopdpercentagepre = mtdGRpre(mtdopdrev,mtdopdrevlastyearpre);
      ...
      branchObj[key].push({
		...
		mtdopdrevlastyearpre: mtdopdrevlastyearpre,
        mtdopdpercentagepre:mtdopdpercentagepre
      });
      (ftdopd = 0),        
        (mtdopd = 0),
		(ftdopdrev = 0),
  ...
  ahcGroups.forEach(group => {
    ...
    ahcgroupedBranches[group].forEach(branch => {
	  ...
	  (ahctempObj[group].mtdopdrevlastyear = mtdopdlastyear),
	   (ahctempObj[group].mtdopdpercentage = mtdopdpercentage),
	     (ahctempObj[group].mtdopdrevlastyearpre = mtdopdlastyearpre),
	   (ahctempObj[group].mtdopdpercentagepre = mtdopdpercentagepre),
	  (ahctempObj[group].branch = group);
    });
    (ftdopd = 0),     
      (mtdopd = 0),
    ...
    ohcgroupedBranches[group].forEach(branch => {
	  ...
	  (ohctempObj[group].mtdopdpercentage = mtdopdpercentage),
	   (ohctempObj[group].mtdopdrevlastyearpre = mtdopdlastyearpre),
	  (ohctempObj[group].mtdopdpercentagepre = mtdopdpercentagepre),
    ...
    ohcgroupedBranches[key].forEach(branch => {
      ...
      mtdopdpercentage = mtdGR(mtdopdrev,mtdopdrevlastyear);
	   mtdopdpercentagepre = mtdGR(mtdopdrev,mtdopdrevlastyearpre);
...
let filterTamilNaduRevenue = async (dbres2, ftddate,lastyearopd,lastyearopdpre,branches) => {
	...
	tamilnaduBranches = {
	"All Chennai Branches" :['CMH','ANN','ASN','AVD','NLR','PMB','PRR','TLR','TRC','VLC','TBM','ADY','EGM','MGP','NWP','AMB','TVT','CMP'],
    "ROTN Branches":['KNP','VLR','KBK','NVL','VPM',"KCH",'DHA','SLM','KSN','ERD','HSR','MDU','TVL','TCN','APM','TRI','TNJ','TPR','CMB',"LMS"],
	"TN Branches":['CMH','ANN','ASN','AVD','NLR','PMB','PRR','TLR','TRC','VLC','TBM','ADY','EGM','MGP','NWP','AMB','TVT','KNP','VLR','KBK','NVL','VPM',"KCH",'DHA','SLM','KSN','ERD','HSR','MDU','TVL','TCN','APM','TRI','TNJ','TPR','CMB','PDY',"LMS",'CMP'],
  
  };
	
	tamilnaduGroups.forEach(group => {
	let tnftd=0,tnmtd=0,tnmtdlastyear=0,tnmtdpercetage=0,tnmtdlastyearpre=0,tnmtdpercetagepre=0,tntarget=0,tnmtdachived=0;
    tntempObj[group] = {};
    tamilnaduBranches[group].forEach(branch => {
      ...
      _.filter(dbres2, { branch: branch }).forEach(element => {
	   ...
	   _.filter(lastyearopdpre, { branch: branch }).forEach(element => {
        tnmtdlastyearpre += element.ftd_count;
       
      });
	  
	  tnmtdpercetage = mtdGR(tnmtd,tnmtdlastyear);
	  tnmtdpercetagepre = mtdGRpre(tnmtd,tnmtdlastyearpre);	  	  
      ...
      (tntempObj[group].mtdopdrevlastyearpre = tnmtdlastyearpre),
	  (tntempObj[group].mtdopdpercentagepre = tnmtdpercetagepre),		  
...
let overseasCurrencyConversionOpt = async (ftddate, currencyres, currencylastres, currres_lst_year) => {
  ...
  let overseasCountryCode = ['MDR', 'NGA', 'RWD', 'ZMW', 'GHA', 'NAB', 'UGD', 'TZA', 'MZN', 'MUR'];
  ...
  if ((Object.keys(overseastempObj).length) > 0) {
    ...
    overseastempObj['ZMB'] = {
      'ftd': overseastempObj.ZMW.ftd,
      'mtd': overseastempObj.ZMW.mtd,
      'lastmtd': overseastempObj.ZMW.lastmtd
    };
    overseastempObj['KWE'] = {
      'ftd': overseastempObj.ZMW.ftd,
      'mtd': overseastempObj.ZMW.mtd,
...
let ovrcalcmtdrev=0,ovrcalclymtdrev=0,calcmtdrev=0,calclymtdrev=0
  ...
  let totalgroupbranches = {
    "OHC":['UGD','TZA','ZMB','KWE','GHA','RWD','CGU','MZQ','BRA','EBN','FLQ','GDL','MDR','NAB','NGA'],
    "Chennai": [
      "CMH",
      "ANN",
      "ASN",
...
"KTM"],
  ...
  alin['mtdoptrev'] = grouptempObj['Chennai'].mtdoptrev + grouptempObj['ROTN'].mtdoptrev + grouptempObj['Karnataka'].mtdoptrev +
	...
	grouptempObj['Punjab'].mtdoptrev +grouptempObj['Gujarat'].mtdoptrev +
  grouptempObj['Jammu'].mtdoptrev +grouptempObj['Jammu'].mtdoptrev +
  ...
  grouptempObj['Punjab'].lstoptrev +grouptempObj['Gujarat'].lstoptrev +
  grouptempObj['Jammu'].lstoptrev +grouptempObj['Jammu'].lstoptrev +
  ...
  grouptempObj['Punjab'].targetmtdrev +grouptempObj['Gujarat'].targetmtdrev +
  grouptempObj['Jammu'].targetmtdrev +grouptempObj['Gujarat'].targetmtdrev +
...
"RAJ","NKR","OTR","NKR",],
  ...
  if(branch=='UGD'||branch=='TZA'||branch=='ZMB'||branch=='KWE'||branch=='GHA'||branch=='RWD'||branch=='CGU'||branch=='MZQ'||branch=='BRA'||branch=='EBN'||branch=='FLQ'|branch=='GDL'||branch=='MDR'||branch=='NGA'||branch=='NAB'){
    _.filter(resmtdopt, {
        BILLED: branch,
        UNIT: 'OPTICALS'
      })
...
let filterGroupwiseUsageTracker = async (
    ...
    let ahcgroupedBranches = {
        "Chennai": ["MGP", "NWP", "AMB", "ADY", "TVT","CMP"],
        "ROTN": ["TVL","TPR"],
...
//console.log(currencyres);
	...
	if((Object.keys(overseastempObj).length) > 0){
      ...
      overseastempObj['KWE'] = {'ftd' : overseastempObj.ZMW.ftd,'mtd' :overseastempObj.ZMW.mtd,'lastmtd':overseastempObj.ZMW.lastmtd};
			overseastempObj['ZMB'] = {'ftd' : overseastempObj.ZMW.ftd,'mtd' :overseastempObj.ZMW.mtd,'lastmtd':overseastempObj.ZMW.lastmtd};
...
let emailTemplateOPD = async (finalResult,todatadate) => {	
	...
	var dateYearlast = parseInt(dateYear)-1;
	var dateYearpre = parseInt(dateYear)-2;
	
	var currYearMtd = parseInt(dateYear)+1;
	...
	if(dateMonth<4){	
		 lastpreyear = "FY"+ String(dateYearpre).slice(-2);
		 lastyear = "FY"+ String(dateYearlast).slice(-2);
		 currYearMtdTxt = "FY"+ String(dateYear).slice(-2);
		 currentyearGr = currYearMtdTxt+'-v-'+lastyear;
		 preyearGr = currYearMtdTxt+'-v-'+lastpreyear;
	}else{
		 lastpreyear = "FY"+ String(dateYearlast).slice(-2);
		 lastyear = "FY"+ String(dateYear).slice(-2);
		 currYearMtdTxt = "FY"+ String(currYearMtd).slice(-2);
		 currentyearGr =  currYearMtdTxt+'-v-'+lastyear;
		 preyearGr = currYearMtdTxt+'-v-'+lastpreyear;
	}
	...
	let project_marvel = finalResult.aehgroup["20|20 Marvel Centers"];
	let project_marvel_branches = finalResult.branchwise["20|20 Marvel Centers"];
	...
	let punjab = finalResult.ahcgroup["Punjab"];
	let punjab_branches = finalResult.branchwise["Punjab"];
  let jammu = finalResult.ahcgroup["Jammu"];
	let jammu_branches = finalResult.branchwise["Jammu"];
  let gujarat = finalResult.ahcgroup["Gujarat"];
	let gujarat_branches = finalResult.branchwise["Gujarat"];
	let mumbai = finalResult.ahcgroup["Mumbai"];
	let mumbai_branches = finalResult.branchwise["Mumbai"];
	let rest_of_maharashtra = finalResult.ahcgroup["Rest of Maharashtra"];
	let rest_of_maharashtra_branches = finalResult.branchwise["Rest of Maharashtra"];
  ...
  let zambia = finalResult.ohcgroup["Zambia"];
	let zambia_branches = finalResult.branchwise["Zambia"];
	...
	let opdTemplate = "<html><body><table cellspacing='0'><tr><td colspan='7' style='text-align:left'><img src='https://mis.dragarwal.com/andaman/mis_logo.png'></td></tr><tr><td colspan='7'></br></td></tr></table><table cellpadding='5' border='1' style='border-collapse: collapse;  border-spacing: 0;border-color: black'><tr><td colspan='7' style='text-align:center'><b>DAILY NEW OPD REPORT AS ON "+ day +"<b></td></tr><tr><td><b>Branch</b></td><td><b>FTD</b></td><td><b>"+currYearMtdTxt+"<br>MTD</b></td><td><b>"+lastyear+"<br> MTD</b></td><td><b>"+currentyearGr+" <br> MTD Gr.%</b></td><td><b>"+lastpreyear+"<br> MTD</b></td><td><b>"+preyearGr+"<br> MTD Gr.%</b></td></tr>";
	
	opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ finalResult.group['branch'] +'</td><td>'+ finalResult.group['ftdopdrev'] +'</td><td>'+ finalResult.group['mtdopdrev'] +'</td><td>'+ finalResult.group['mtdopdrevlastyear'] +'</td><td>'+ finalResult.group['mtdopdpercentage'] +'</td><td>'+ finalResult.group['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.group['mtdopdpercentagepre'] +'</td></tr>';
	
	
	opdTemplate+='<tr bgcolor="#f0ae19" style="background:#f0ae19!important;text-align:center;color:#FFFFFF"><td align="left">'+ finalResult.alin['branch'] +'</td><td>'+ finalResult.alin['ftdopdrev'] +'</td><td>'+ finalResult.alin['mtdopdrev'] +'</td><td>'+ finalResult.alin['mtdopdrevlastyear'] +'</td><td>'+ finalResult.alin['mtdopdpercentage'] +'</td><td>'+ finalResult.alin['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.alin['mtdopdpercentagepre'] +'</td></tr>';
	
	opdTemplate+='<tr bgcolor="#f0ae19" style="background:#f0ae19!important;text-align:center;color:#FFFFFF"><td align="left">'+ finalResult.aeh['branch'] +'</td><td>'+ finalResult.aeh['ftdopdrev'] +'</td><td>'+ finalResult.aeh['mtdopdrev'] +'</td><td>'+ finalResult.aeh['mtdopdrevlastyear'] +'</td><td>'+ finalResult.aeh['mtdopdpercentage'] +'</td><td>'+ finalResult.aeh['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.aeh['mtdopdpercentagepre'] +'</td></tr>';
	
	
	
	opdTemplate+='<tr  bgcolor="#f0ae19" style="background:#f0ae19!important;text-align:center;color:#FFFFFF"><td align="left">'+ finalResult.ahc['branch'] +'</td><td>'+ finalResult.ahc['ftdopdrev'] +'</td><td>'+ finalResult.ahc['mtdopdrev'] +'</td><td>'+ finalResult.ahc['mtdopdrevlastyear'] +'</td><td>'+ finalResult.ahc['mtdopdpercentage'] +'</td><td>'+ finalResult.ahc['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.ahc['mtdopdpercentagepre'] +'</td></tr>';
	
	opdTemplate+='<tr  bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ finalResult.ohc['branch'] +'</td><td>'+ finalResult.ohc['ftdopdrev'] +'</td><td>'+ finalResult.ohc['mtdopdrev'] +'</td><td>'+ finalResult.ohc['mtdopdrevlastyear'] +'</td><td>'+ finalResult.ohc['mtdopdpercentage'] +'</td><td>'+ finalResult.ohc['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.ohc['mtdopdpercentagepre'] +'</td></tr>';
	
	
	opdTemplate+='<tr bgcolor="#3a75b5" style="background:#3a75b5!important;text-align:center;color:#FFFFFF"><td align="left">'+ finalResult.allchennai['branch'] +'</td><td>'+ finalResult.allchennai['ftdopdrev'] +'</td><td>'+ finalResult.allchennai['mtdopdrev'] +'</td><td>'+ finalResult.allchennai['mtdopdrevlastyear'] +'</td><td>'+ finalResult.allchennai['mtdopdpercentage'] +'</td><td>'+ finalResult.allchennai['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.allchennai['mtdopdpercentagepre'] +'</td></tr>';
		
		
		opdTemplate+='<tr bgcolor="#3a75b5" style="background:#3a75b5!important;text-align:center;color:#FFFFFF"><td align="left">'+ finalResult.rotn['branch'] +'</td><td>'+ finalResult.rotn['ftdopdrev'] +'</td><td>'+ finalResult.rotn['mtdopdrev'] +'</td><td>'+ finalResult.rotn['mtdopdrevlastyear'] +'</td><td>'+ finalResult.rotn['mtdopdpercentage'] +'</td><td>'+ finalResult.rotn['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.rotn['mtdopdpercentagepre'] +'</td></tr>';
		
		opdTemplate+='<tr bgcolor="#3a75b5" style="background:#3a75b5!important;text-align:center;color:#FFFFFF"><td align="left">'+ finalResult.tnbranches['branch'] +'</td><td>'+ finalResult.tnbranches['ftdopdrev'] +'</td><td>'+ finalResult.tnbranches['mtdopdrev'] +'</td><td>'+ finalResult.tnbranches['mtdopdrevlastyear'] +'</td><td>'+ finalResult.tnbranches['mtdopdpercentage'] +'</td><td>'+ finalResult.tnbranches['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.tnbranches['mtdopdpercentagepre'] +'</td></tr>';	
	
	
	
	opdTemplate+=  '<tr  bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ karnataka.branch +'</td><td>'+ karnataka.ftdopdrev +'</td><td>'+ karnataka.mtdopdrev +'</td><td>'+ karnataka.mtdopdrevlastyear +'</td><td>'+ karnataka.mtdopdpercentage +'</td><td>'+ karnataka.mtdopdrevlastyearpre +'</td><td>'+ karnataka.mtdopdpercentagepre +'</td></tr>';
		
		opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ maharashtra.branch +'</td><td>'+ maharashtra.ftdopdrev +'</td><td>'+ maharashtra.mtdopdrev +'</td><td>'+ maharashtra.mtdopdrevlastyear +'</td><td>'+ maharashtra.mtdopdpercentage +'</td><td>'+ maharashtra.mtdopdrevlastyearpre +'</td><td>'+ maharashtra.mtdopdpercentagepre +'</td></tr>';
		
		opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ punjab.branch +'</td><td>'+ punjab.ftdopdrev +'</td><td>'+ punjab.mtdopdrev +'</td><td>'+ punjab.mtdopdrevlastyear +'</td><td>'+ punjab.mtdopdpercentage +'</td><td>'+ punjab.mtdopdrevlastyearpre +'</td><td>'+ punjab.mtdopdpercentagepre +'</td></tr>';
    opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ jammu.branch +'</td><td>'+ jammu.ftdopdrev +'</td><td>'+ jammu.mtdopdrev +'</td><td>'+ jammu.mtdopdrevlastyear +'</td><td>'+ jammu.mtdopdpercentage +'</td><td>'+ jammu.mtdopdrevlastyearpre +'</td><td>'+ jammu.mtdopdpercentagepre +'</td></tr>';
    opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ gujarat.branch +'</td><td>'+ gujarat.ftdopdrev +'</td><td>'+ gujarat.mtdopdrev +'</td><td>'+ gujarat.mtdopdrevlastyear +'</td><td>'+ gujarat.mtdopdpercentage +'</td><td>'+ gujarat.mtdopdrevlastyearpre +'</td><td>'+ gujarat.mtdopdpercentagepre +'</td></tr>';
		
		opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ telangana.branch +'</td><td>'+ telangana.ftdopdrev +'</td><td>'+ telangana.mtdopdrev +'</td><td>'+ telangana.mtdopdrevlastyear +'</td><td>'+ telangana.mtdopdpercentage +'</td><td>'+ telangana.mtdopdrevlastyearpre +'</td><td>'+ telangana.mtdopdpercentagepre +'</td></tr>';
		
		opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ andhra.branch +'</td><td>'+ andhra.ftdopdrev +'</td><td>'+ andhra.mtdopdrev +'</td><td>'+ andhra.mtdopdrevlastyear +'</td><td>'+ andhra.mtdopdpercentage +'</td><td>'+ andhra.mtdopdrevlastyearpre +'</td><td>'+ andhra.mtdopdpercentagepre +'</td></tr>';
		
		
		opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ kerla.branch +'</td><td>'+ kerla.ftdopdrev +'</td><td>'+ kerla.mtdopdrev +'</td><td>'+ kerla.mtdopdrevlastyear +'</td><td>'+ kerla.mtdopdpercentage +'</td><td>'+ kerla.mtdopdrevlastyearpre +'</td><td>'+ kerla.mtdopdpercentagepre +'</td></tr>';
		
		opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ kolk.branch +'</td><td>'+ kolk.ftdopdrev +'</td><td>'+ kolk.mtdopdrev +'</td><td>'+ kolk.mtdopdrevlastyear +'</td><td>'+ kolk.mtdopdpercentage +'</td><td>'+ kolk.mtdopdrevlastyearpre +'</td><td>'+ kolk.mtdopdpercentagepre +'</td></tr>';
		
		opdTemplate+=  '<tr  bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ ahmedabad[0].branch +'</td><td>'+ ahmedabad[0].ftdopdrev +'</td><td>'+ ahmedabad[0].mtdopdrev +'</td><td>'+ ahmedabad[0].mtdopdrevlastyear +'</td><td>'+ ahmedabad[0].mtdopdpercentage +'</td><td>'+ ahmedabad[0].mtdopdrevlastyearpre +'</td><td>'+ ahmedabad[0].mtdopdpercentagepre +'</td></tr>';


		opdTemplate+=  '<tr  bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ madhyapradesh.branch +'</td><td>'+ madhyapradesh.ftdopdrev +'</td><td>'+ madhyapradesh.mtdopdrev +'</td><td>'+ madhyapradesh.mtdopdrevlastyear +'</td><td>'+ madhyapradesh.mtdopdpercentage +'</td><td>'+ madhyapradesh.mtdopdrevlastyearpre +'</td><td>'+ madhyapradesh.mtdopdpercentagepre +'</td></tr>';
		
		opdTemplate+=  '<tr bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">'+ odisha.branch +'</td><td>'+ odisha.ftdopdrev +'</td><td>'+ odisha.mtdopdrev +'</td><td>'+ odisha.mtdopdrevlastyear +'</td><td>'+ odisha.mtdopdpercentage +'</td><td>'+ odisha.mtdopdrevlastyearpre +'</td><td>'+ odisha.mtdopdpercentagepre +'</td></tr>';
	
	opdTemplate+='<tr bgcolor="#3a75b5"  style="background:#3a75b5!important;color:#FFFFFF"><td>AEHL:</td><td></td><td></td><td></td><td></td><td></td><td></td></tr>';
	
	opdTemplate+='<tr style="text-align:center" style="color:#5d6476"><td align="left" style="color:#5d6476">'+ cmh[0].branch +'</td><td>'+ cmh[0].ftdopdrev +'</td><td>'+ cmh[0].mtdopdrev +'</td><td>'+ cmh[0].mtdopdrevlastyear +'</td><td>'+ cmh[0].mtdopdpercentage +'</td><td>'+ cmh[0].mtdopdrevlastyearpre +'</td><td>'+ cmh[0].mtdopdpercentagepre +'</td></tr>';
	
	opdTemplate+='<tr bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ aeh_chennai.branch +'</td><td>'+ aeh_chennai.ftdopdrev +'</td><td>'+ aeh_chennai.mtdopdrev +'</td><td>'+ aeh_chennai.mtdopdrevlastyear +'</td><td>'+ aeh_chennai.mtdopdpercentage +'</td><td>'+ aeh_chennai.mtdopdrevlastyearpre +'</td><td>'+ aeh_chennai.mtdopdpercentagepre +'</td></tr>';
	
	
	aeh_chennai_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';    
	});
	
	
    opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ kanchi_vel.branch +'</td><td>'+ kanchi_vel.ftdopdrev +'</td><td>'+ kanchi_vel.mtdopdrev +'</td><td>'+ kanchi_vel.mtdopdrevlastyear +'</td><td>'+ kanchi_vel.mtdopdpercentage +'</td><td>'+ kanchi_vel.mtdopdrevlastyearpre +'</td><td>'+ kanchi_vel.mtdopdpercentagepre +'</td></tr>';
	...
	opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ kum_ney_vil.branch +'</td><td>'+ kum_ney_vil.ftdopdrev +'</td><td>'+ kum_ney_vil.mtdopdrev +'</td><td>'+ kum_ney_vil.mtdopdrevlastyear +'</td><td>'+ kum_ney_vil.mtdopdpercentage +'</td><td>'+ kum_ney_vil.mtdopdrevlastyearpre +'</td><td>'+ kum_ney_vil.mtdopdpercentagepre +'</td></tr>';
	...
	opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ dha_salem_krish.branch +'</td><td>'+ dha_salem_krish.ftdopdrev +'</td><td>'+ dha_salem_krish.mtdopdrev +'</td><td>'+ dha_salem_krish.mtdopdrevlastyear +'</td><td>'+ dha_salem_krish.mtdopdpercentage +'</td><td>'+ dha_salem_krish.mtdopdrevlastyearpre +'</td><td>'+ dha_salem_krish.mtdopdpercentagepre +'</td></tr>';

		dha_salem_krish_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});
		
	opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ erod_hosure.branch +'</td><td>'+ erod_hosure.ftdopdrev +'</td><td>'+ erod_hosure.mtdopdrev +'</td><td>'+ erod_hosure.mtdopdrevlastyear +'</td><td>'+ erod_hosure.mtdopdpercentage +'</td><td>'+ erod_hosure.mtdopdrevlastyearpre +'</td><td>'+ erod_hosure.mtdopdpercentagepre +'</td></tr>';

		erod_hosure_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});
		
	opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ jaipur[0].branch +'</td><td>'+ jaipur[0].ftdopdrev +'</td><td>'+ jaipur[0].mtdopdrev +'</td><td>'+ jaipur[0].mtdopdrevlastyear +'</td><td>'+ jaipur[0].mtdopdpercentage +'</td><td>'+ jaipur[0].mtdopdrevlastyearpre +'</td><td>'+ jaipur[0].mtdopdpercentagepre +'</td></tr>';
	
	opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ project_marvel.branch +'</td><td>'+ project_marvel.ftdopdrev +'</td><td>'+ project_marvel.mtdopdrev +'</td><td>'+ project_marvel.mtdopdrevlastyear +'</td><td>'+ project_marvel.mtdopdpercentage +'</td><td>'+ project_marvel.mtdopdrevlastyearpre +'</td><td>'+ project_marvel.mtdopdpercentagepre +'</td></tr>';

		project_marvel_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

		opdTemplate+=  '<tr bgcolor="#f0ae19" style="background:#f0ae19!important;color:#FFFFFF"><td>AHCL:</td><td></td><td></td><td></td><td></td><td></td><td></td></tr><tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ ahc_chennai.branch +'</td><td>'+ ahc_chennai.ftdopdrev +'</td><td>'+ ahc_chennai.mtdopdrev +'</td><td>'+ ahc_chennai.mtdopdrevlastyear +'</td><td>'+ ahc_chennai.mtdopdpercentage +'</td><td>'+ ahc_chennai.mtdopdrevlastyearpre +'</td><td>'+ ahc_chennai.mtdopdpercentagepre +'</td></tr>';
	...
	ahc_chennai_branches.forEach(element => {
		...
		opdTemplate+=  '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ pondycherry[0].branch +'</td><td>'+ pondycherry[0].ftdopdrev +'</td><td>'+ pondycherry[0].mtdopdrev +'</td><td>'+ pondycherry[0].mtdopdrevlastyear +'</td><td>'+ pondycherry[0].mtdopdpercentage +'</td><td>'+ pondycherry[0].mtdopdrevlastyearpre +'</td><td>'+ pondycherry[0].mtdopdpercentagepre +'</td></tr>';

		opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ tirunelveli[0].branch +'</td><td>'+ tirunelveli[0].ftdopdrev +'</td><td>'+ tirunelveli[0].mtdopdrev +'</td><td>'+ tirunelveli[0].mtdopdrevlastyear +'</td><td>'+ tirunelveli[0].mtdopdpercentage +'</td><td>'+ tirunelveli[0].mtdopdrevlastyearpre +'</td><td>'+ tirunelveli[0].mtdopdpercentagepre +'</td></tr>';

		opdTemplate+=  '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ tirunelveli[0].branch +'</td><td>'+ tirunelveli[0].ftdopdrev +'</td><td>'+ tirunelveli[0].mtdopdrev +'</td><td>'+ tirunelveli[0].mtdopdrevlastyear +'</td><td>'+ tirunelveli[0].mtdopdpercentage +'</td><td>'+ tirunelveli[0].mtdopdrevlastyearpre +'</td><td>'+ tirunelveli[0].mtdopdpercentagepre +'</td></tr>';


		coimbatore.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';    
		});

				
		opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ tiruppur[0].branch +'</td><td>'+ tiruppur[0].ftdopdrev +'</td><td>'+ tiruppur[0].mtdopdrev +'</td><td>'+ tiruppur[0].mtdopdrevlastyear +'</td><td>'+ tiruppur[0].mtdopdpercentage +'</td><td>'+ tiruppur[0].mtdopdrevlastyearpre +'</td><td>'+ tiruppur[0].mtdopdpercentagepre +'</td></tr>';
		
		
		opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ tuti_madurai.branch +'</td><td>'+ tuti_madurai.ftdopdrev +'</td><td>'+ tuti_madurai.mtdopdrev +'</td><td>'+ tuti_madurai.mtdopdrevlastyear +'</td><td>'+ tuti_madurai.mtdopdpercentage +'</td><td>'+ tuti_madurai.mtdopdrevlastyearpre +'</td><td>'+ tuti_madurai.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ trichy[0].branch +'</td><td>'+trichy[0].ftdopdrev +'</td><td>'+ trichy[0].mtdopdrev +'</td><td>'+ trichy[0].mtdopdrevlastyear +'</td><td>'+ trichy[0].mtdopdpercentage +'</td><td>'+ trichy[0].mtdopdrevlastyearpre +'</td><td>'+ trichy[0].mtdopdpercentagepre +'</td></tr>';

		opdTemplate+=  '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ thanjavur[0].branch +'</td><td>'+ thanjavur[0].ftdopdrev +'</td><td>'+ thanjavur[0].mtdopdrev +'</td><td>'+ thanjavur[0].mtdopdrevlastyear +'</td><td>'+ thanjavur[0].mtdopdpercentage +'</td><td>'+ thanjavur[0].mtdopdrevlastyearpre +'</td><td>'+ thanjavur[0].mtdopdpercentagepre +'</td></tr>';
		
		
		opdTemplate+=  '<tr bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ andaman.branch +'</td><td>'+ andaman.ftdopdrev +'</td><td>'+ andaman.mtdopdrev +'</td><td>'+ andaman.mtdopdrevlastyear +'</td><td>'+ andaman.mtdopdpercentage +'</td><td>'+ andaman.mtdopdrevlastyearpre +'</td><td>'+ andaman.mtdopdpercentagepre +'</td></tr>';
		


        opdTemplate+=  '<tr  bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ karnataka.branch +'</td><td>'+ karnataka.ftdopdrev +'</td><td>'+ karnataka.mtdopdrev +'</td><td>'+ karnataka.mtdopdrevlastyear +'</td><td>'+ karnataka.mtdopdpercentage +'</td><td>'+ karnataka.mtdopdrevlastyearpre +'</td><td>'+ karnataka.mtdopdpercentagepre +'</td></tr>';

		opdTemplate+=  '<tr bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ banglore.branch +'</td><td>'+ banglore.ftdopdrev +'</td><td>'+ banglore.mtdopdrev +'</td><td>'+ banglore.mtdopdrevlastyear +'</td><td>'+ banglore.mtdopdpercentage +'</td><td>'+ banglore.mtdopdrevlastyearpre +'</td><td>'+ banglore.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ hub_mys.branch +'</td><td>'+ hub_mys.ftdopdrev +'</td><td>'+ hub_mys.mtdopdrev +'</td><td>'+ hub_mys.mtdopdrevlastyear +'</td><td>'+ hub_mys.mtdopdpercentage +'</td><td>'+ hub_mys.mtdopdrevlastyearpre +'</td><td>'+ hub_mys.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ maharashtra.branch +'</td><td>'+ maharashtra.ftdopdrev +'</td><td>'+ maharashtra.mtdopdrev +'</td><td>'+ maharashtra.mtdopdrevlastyear +'</td><td>'+ maharashtra.mtdopdpercentage +'</td><td>'+ maharashtra.mtdopdrevlastyearpre +'</td><td>'+ maharashtra.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ mumbai.branch +'</td><td>'+ mumbai.ftdopdrev +'</td><td>'+ mumbai.mtdopdrev +'</td><td>'+ mumbai.mtdopdrevlastyear +'</td><td>'+ mumbai.mtdopdpercentage +'</td><td>'+ mumbai.mtdopdrevlastyearpre +'</td><td>'+ mumbai.mtdopdpercentagepre +'</td></tr>';

		mumbai_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});
		
		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ rest_of_maharashtra.branch +'</td><td>'+ rest_of_maharashtra.ftdopdrev +'</td><td>'+ rest_of_maharashtra.mtdopdrev +'</td><td>'+ rest_of_maharashtra.mtdopdrevlastyear +'</td><td>'+ rest_of_maharashtra.mtdopdpercentage +'</td><td>'+ rest_of_maharashtra.mtdopdrevlastyearpre +'</td><td>'+ rest_of_maharashtra.mtdopdpercentagepre +'</td></tr>';

		rest_of_maharashtra_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ punjab.branch +'</td><td>'+ punjab.ftdopdrev +'</td><td>'+ punjab.mtdopdrev +'</td><td>'+ punjab.mtdopdrevlastyear +'</td><td>'+ punjab.mtdopdpercentage +'</td><td>'+ punjab.mtdopdrevlastyearpre +'</td><td>'+ punjab.mtdopdpercentagepre +'</td></tr>';

		punjab_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

    opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ jammu.branch +'</td><td>'+ jammu.ftdopdrev +'</td><td>'+ jammu.mtdopdrev +'</td><td>'+ jammu.mtdopdrevlastyear +'</td><td>'+ jammu.mtdopdpercentage +'</td><td>'+ jammu.mtdopdrevlastyearpre +'</td><td>'+ jammu.mtdopdpercentagepre +'</td></tr>';

		jammu_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

    opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ gujarat.branch +'</td><td>'+ gujarat.ftdopdrev +'</td><td>'+ gujarat.mtdopdrev +'</td><td>'+ gujarat.mtdopdrevlastyear +'</td><td>'+ gujarat.mtdopdpercentage +'</td><td>'+ gujarat.mtdopdrevlastyearpre +'</td><td>'+ gujarat.mtdopdpercentagepre +'</td></tr>';

		gujarat_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});
		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ telangana.branch +'</td><td>'+ telangana.ftdopdrev +'</td><td>'+ telangana.mtdopdrev +'</td><td>'+ telangana.mtdopdrevlastyear +'</td><td>'+ telangana.mtdopdpercentage +'</td><td>'+ telangana.mtdopdrevlastyearpre +'</td><td>'+ telangana.mtdopdpercentagepre +'</td></tr>';


		opdTemplate+=  '<tr bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ hyderabad.branch +'</td><td>'+ hyderabad.ftdopdrev +'</td><td>'+ hyderabad.mtdopdrev +'</td><td>'+ hyderabad.mtdopdrevlastyear +'</td><td>'+ hyderabad.mtdopdpercentage +'</td><td>'+ hyderabad.mtdopdrevlastyearpre +'</td><td>'+ hyderabad.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ andhra.branch +'</td><td>'+ andhra.ftdopdrev +'</td><td>'+ andhra.mtdopdrev +'</td><td>'+ andhra.mtdopdrevlastyear +'</td><td>'+ andhra.mtdopdpercentage +'</td><td>'+ andhra.mtdopdrevlastyearpre +'</td><td>'+ andhra.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ roi.branch +'</td><td>'+ roi.ftdopdrev +'</td><td>'+ roi.mtdopdrev +'</td><td>'+ roi.mtdopdrevlastyear +'</td><td>'+ roi.mtdopdpercentage +'</td><td>'+ roi.mtdopdrevlastyearpre +'</td><td>'+ roi.mtdopdpercentagepre +'</td></tr>';


		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ kerla.branch +'</td><td>'+ kerla.ftdopdrev +'</td><td>'+ kerla.mtdopdrev +'</td><td>'+ kerla.mtdopdrevlastyear +'</td><td>'+ kerla.mtdopdpercentage +'</td><td>'+ kerla.mtdopdrevlastyearpre +'</td><td>'+ kerla.mtdopdpercentagepre +'</td></tr>';

		kerla_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

		opdTemplate+=  '<tr bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ kolk.branch +'</td><td>'+ kolk.ftdopdrev +'</td><td>'+ kolk.mtdopdrev +'</td><td>'+ kolk.mtdopdrevlastyear +'</td><td>'+ kolk.mtdopdpercentage +'</td><td>'+ kolk.mtdopdrevlastyearpre +'</td><td>'+ kolk.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr  bgcolor="#7083a9" style="background:#7083a9!important;color:#FFFFFF;text-align:center"><td align="left">'+ ahmedabad[0].branch +'</td><td>'+ ahmedabad[0].ftdopdrev +'</td><td>'+ ahmedabad[0].mtdopdrev +'</td><td>'+ ahmedabad[0].mtdopdrevlastyear +'</td><td>'+ ahmedabad[0].mtdopdpercentage +'</td><td>'+ ahmedabad[0].mtdopdrevlastyearpre +'</td><td>'+ ahmedabad[0].mtdopdpercentagepre +'</td></tr>';


		opdTemplate+=  '<tr  bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ madhyapradesh.branch +'</td><td>'+ madhyapradesh.ftdopdrev +'</td><td>'+ madhyapradesh.mtdopdrev +'</td><td>'+ madhyapradesh.mtdopdrevlastyear +'</td><td>'+ madhyapradesh.mtdopdpercentage +'</td><td>'+ madhyapradesh.mtdopdrevlastyearpre +'</td><td>'+ madhyapradesh.mtdopdpercentagepre +'</td></tr>';
		...
		opdTemplate+=  '<tr bgcolor="#264e99" style="background:#264e99!important;color:#FFFFFF;text-align:center"><td align="left">'+ odisha.branch +'</td><td>'+ odisha.ftdopdrev +'</td><td>'+ odisha.mtdopdrev +'</td><td>'+ odisha.mtdopdrevlastyear +'</td><td>'+ odisha.mtdopdpercentage +'</td><td>'+ odisha.mtdopdrevlastyearpre +'</td><td>'+ odisha.mtdopdpercentagepre +'</td></tr>';

		odisha_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5d6476">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

		opdTemplate+= '<tr  bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;"><td>OHCL:</td><td></td><td></td><td></td><td></td><td></td><td></td></tr>';
		
		opdTemplate+='<tr  bgcolor="#3a75b5" style="background:#3a75b5!important;color:#FFFFFF;text-align:center"><td align="left">OHC (Overall count )</td><td>'+ finalResult.ohc['ftdopdrev'] +'</td><td>'+ finalResult.ohc['mtdopdrev'] +'</td><td>'+ finalResult.ohc['mtdopdrevlastyear'] +'</td><td>'+ finalResult.ohc['mtdopdpercentage'] +'</td><td>'+ finalResult.ohc['mtdopdrevlastyearpre'] +'</td><td>'+ finalResult.ohc['mtdopdpercentagepre'] +'</td></tr>';

		opdTemplate+=  '<tr  bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ madagascar[0].branch +'</td><td>'+ madagascar[0].ftdopdrev +'</td><td>'+ madagascar[0].mtdopdrev +'</td><td>'+ madagascar[0].mtdopdrevlastyear +'</td><td>'+ madagascar[0].mtdopdpercentage +'</td><td>'+ madagascar[0].mtdopdrevlastyearpre +'</td><td>'+ madagascar[0].mtdopdpercentagepre +'</td></tr>';

		opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ mozambique.branch +'</td><td>'+ mozambique.ftdopdrev +'</td><td>'+ mozambique.mtdopdrev +'</td><td>'+ mozambique.mtdopdrevlastyear +'</td><td>'+ mozambique.mtdopdpercentage +'</td><td>'+ mozambique.mtdopdrevlastyearpre +'</td><td>'+ mozambique.mtdopdpercentagepre +'</td></tr>';

		mozambique_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5b5e60">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

//		opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ nigeria[0].branch +'</td><td>'+ nigeria[0].ftdopdrev +'</td><td>'+ nigeria[0].mtdopdrev +'</td><td>'+ nigeria[0].mtdopdrevlastyear +'</td><td>'+ nigeria[0].mtdopdpercentage +'</td><td>'+ nigeria[0].mtdopdrevlastyearpre +'</td><td>'+ nigeria[0].mtdopdpercentagepre +'</td></tr>';


		opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center;"><td align="left" style="color:#5b5e60">'+ rwanda.branch +'</td><td>'+ rwanda.ftdopdrev +'</td><td>'+ rwanda.mtdopdrev +'</td><td>'+ rwanda.mtdopdrevlastyear +'</td><td>'+ rwanda.mtdopdpercentage +'</td><td>'+ rwanda.mtdopdrevlastyearpre +'</td><td>'+ rwanda.mtdopdpercentagepre +'</td></tr>';

		rwanda_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5b5e60">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

		opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ mauritius.branch +'</td><td>'+ mauritius.ftdopdrev +'</td><td>'+ mauritius.mtdopdrev +'</td><td>'+ mauritius.mtdopdrevlastyear +'</td><td>'+ mauritius.mtdopdpercentage +'</td><td>'+ mauritius.mtdopdrevlastyearpre +'</td><td>'+ mauritius.mtdopdpercentagepre +'</td></tr>';

		mauritius_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5b5e60">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});

		//opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ zambia[0].branch +'</td><td>'+ zambia[0].ftdopdrev +'</td><td>'+ zambia[0].mtdopdrev +'</td><td>'+ zambia[0].mtdopdrevlastyear +'</td><td>'+ zambia[0].mtdopdpercentage +'</td><td>'+ zambia[0].mtdopdrevlastyearpre +'</td><td>'+ zambia[0].mtdopdpercentagepre +'</td></tr>';
    opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ zambia.branch +'</td><td>'+ zambia.ftdopdrev +'</td><td>'+ zambia.mtdopdrev +'</td><td>'+ zambia.mtdopdrevlastyear +'</td><td>'+ zambia.mtdopdpercentage +'</td><td>'+ zambia.mtdopdrevlastyearpre +'</td><td>'+ zambia.mtdopdpercentagepre +'</td></tr>';

		zambia_branches.forEach(element => {
		opdTemplate+= '<tr style="text-align:center"><td align="left" style="color:#5b5e60">'+ element.branch +'</td><td>'+ element.ftdopdrev +'</td><td>'+ element.mtdopdrev +'</td><td>'+ element.mtdopdrevlastyear +'</td><td>'+ element.mtdopdpercentage +'</td><td>'+ element.mtdopdrevlastyearpre +'</td><td>'+ element.mtdopdpercentagepre +'</td></tr>';
		});


		opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ ghana[0].branch +'</td><td>'+ ghana[0].ftdopdrev +'</td><td>'+ ghana[0].mtdopdrev +'</td><td>'+ ghana[0].mtdopdrevlastyear +'</td><td>'+ ghana[0].mtdopdpercentage +'</td><td>'+ ghana[0].mtdopdrevlastyearpre +'</td><td>'+ ghana[0].mtdopdpercentagepre +'</td></tr>';


		opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ nairobi[0].branch +'</td><td>'+ nairobi[0].ftdopdrev +'</td><td>'+ nairobi[0].mtdopdrev +'</td><td>'+ nairobi[0].mtdopdrevlastyear +'</td><td>'+ nairobi[0].mtdopdpercentage +'</td><td>'+ nairobi[0].mtdopdrevlastyearpre +'</td><td>'+ nairobi[0].mtdopdpercentagepre +'</td></tr>';


		opdTemplate+=  '<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ uganda[0].branch +'</td><td>'+ uganda[0].ftdopdrev +'</td><td>'+ uganda[0].mtdopdrev +'</td><td>'+ uganda[0].mtdopdrevlastyear +'</td><td>'+ uganda[0].mtdopdpercentage +'</td><td>'+ uganda[0].mtdopdrevlastyearpre +'</td><td>'+ uganda[0].mtdopdpercentagepre +'</td></tr>';


		opdTemplate+='<tr bgcolor="#f9e699" style="background:#f9e699!important;text-align:center"><td align="left" style="color:#5b5e60">'+ tanzania[0].branch +'</td><td>'+ tanzania[0].ftdopdrev +'</td><td>'+ tanzania[0].mtdopdrev +'</td><td>'+ tanzania[0].mtdopdrevlastyear +'</td><td>'+ tanzania[0].mtdopdpercentage +'</td><td>'+ tanzania[0].mtdopdrevlastyearpre +'</td><td>'+ tanzania[0].mtdopdpercentagepre +'</td></tr>';
...
function mtdGRpre(opd,opdlastyearpre){
	let monthGD = 0;
	let monthGDpre = 0;
	monthGD = opd / opdlastyearpre;
	let timeperoid = 1/2;
	
	
	monthGDpre = Math.round((((Math.pow(monthGD, timeperoid))-1)*100));
	
	if(isNaN(monthGDpre)==true || monthGDpre=='Infinity' || monthGDpre=='-Infinity'){
		return '-';
	}else{
		return monthGDpre;
	}
