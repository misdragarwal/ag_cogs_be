...
exports.opr_piad_op_qry=read("./queries/opr_pid_review.sql");
exports.opr_total_consu_qry=read("./queries/opr_total_consu.sql");
exports.opr_all_cat_surg_qry=read("./queries/opr_all_cat_surg.sql");
exports.opr_cat_low_end=read("./queries/opr_cat_low_end.sql");
exports.opr_cat_mid_end=read("./queries/opr_cat_mid_end.sql");
exports.opr_cat_high_end=read("./queries/opr_cat_high_end.sql");
exports.opr_corena=read("./queries/opr_corena.sql");
exports.opr_referctive=read("./queries/opr_referctive.sql");
exports.opr_vr_inju=read("./queries/opr_vr_inju.sql");
exports.opr_vr_surgery=read("./queries/opr_vr_surgery.sql");
exports.opr_phar=read("./queries/opr_phar.sql");
exports.opr_optical=read("./queries/opr_optical.sql");
exports.opr_contact=read("./queries/opr_contact.sql");
exports.opr_other_sug=read("./queries/opr_other_sug.sql");
exports.opr_treat=read("./queries/opr_treat.sql");
exports.opr_invest=read("./queries/opr_invest.sql");
...
exports.fincashreconemail=read("./queries/fincashreconemail.sql");
exports.totalcollectionfin=read("./queries/totalcollectionfin.sql");
exports.collection_recon_weekly=read("./queries/collection_recon_weekly.sql");
exports.collection_recon_weekly_header=read("./queries/collection_recon_weekly_header.sql");
exports.stock_expiry=read("./queries/stock_expiry.sql");

exports.paid_op_details=read("./queries/paid_op_backup.sql");


exports.pc_summary=read("./queries/pc_summary.sql");
exports.pc_detail=read("./queries/pc_detail.sql");
exports.Ns_collection_upload=read("./queries/Collection_integration.sql");
exports.Batch_Wise_stock=read("./queries/Batch_Wise_stock.sql");
